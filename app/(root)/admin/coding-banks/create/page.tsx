  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push(`/admin/coding-banks/${data.data.bankId}/questions`);
      } else {
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">Create Coding Question Bank</h1>
        </div>
...
export default CreateCodingBankPage;
